      ...
      <div className="rounded-3xl shadow-2xl border border-white p-10 w-full max-w-md bg-white/80 text-center animate-fade-in">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <button
            type="submit"
            disabled={isDisabled}
            className="w-full text-2xl tracking-widest bg-[url('/bg_2_cropped.jpg')] bg-cover bg-bottom rounded-xl text-white py-2 
               hover:scale-102 transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
